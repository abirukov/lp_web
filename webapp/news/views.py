from flask import abort, flash, Blueprint, current_app, render_template, redirect, request, url_for
...
def single_news(news_id):
    ...
    return render_template('news/single_news.html', page_title=my_news.title, news=my_news, comment_form=form)
